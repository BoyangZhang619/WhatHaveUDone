                ...
                <div class="grid">
                    ...
                    <div class="panel">
                        <div class="panel-head">
                            ...
                            <div class="panel-tools">
                                <select v-model="_draft.template" @change="applyTemplate" class="mini-select">
                                    <option value="">-</option>
                                ...
                                <label class="toggle">
                                    <input type="checkbox" v-model="_draft.pinToTop" />
                                    <span>{{
                        ...
                        <div class="field">
                            ...
                            <input v-model.trim="_draft.title" maxlength="120"
                        ...
                        <div class="row">
                            <div class="field">
                                ...
                                <input v-model="_draft.happenedAt" type="datetime-local" />
                            </div>
                            <div class="field">
                                <label>{{ $t("overlay_rest.left.duration") }}</label>
                                <input v-model.number="_draft.durationMin" type="number" min="0" max="1440"
                        ...
                        <div class="field">
                            ...
                            <div class="tagbox">
                                <div>
                                    <span class="tag" v-for="t in _draft.tags" :key="t">
                                        {{ t }}
                        ...
                        <div class="field">
                            ...
                            <textarea v-model.trim="_draft.goal" rows="3"
                    ...
                    <div class="panel">
                        ...
                        <div class="field" v-if="!ui.previewMode">
                            ...
                            <textarea v-model.trim="_draft.content" rows="14"
                        ...
                        <div class="field">
                            ...
                            <ul class="todo-list" v-if="_draft.todos.length">
                                <li v-for="(t, i) in _draft.todos" :key="i">
...
const {
  ...
  draft, editDraft, tagInput, todoInput, mode,
...
const _draft = computed(() => (mode.value === "edit" ? editDraft : draft));
</script>